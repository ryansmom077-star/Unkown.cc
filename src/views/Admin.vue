                    ...
                    <td style="padding:8px">
                      <div style="position:relative;display:inline-block">
                        ...
                        <div v-if="openUserMenuId === usr.id" :style="{position:'fixed',left:userMenuX + 'px',top:userMenuY + 'px',background:'linear-gradient(135deg,#0b1b22,#061218)',border:'2px solid rgba(0,255,136,0.3)',borderRadius:'12px',minWidth:'240px',zIndex:1000,boxShadow:'0 16px 40px rgba(0,0,0,0.6), 0 0 20px rgba(0,255,136,0.2)',padding:'8px 0',backdropFilter:'blur(10px)'}">
                          ...
                          <button v-if="isAdmin" @click="setStaffRole(usr.id, 'manager'); closeUserMenu()" style="display:block;width:100%;text-align:left;padding:10px 16px;background:transparent;border:none;color:#d9eef5;cursor:pointer;transition:all 0.2s;font-size:13px" onmouseover="this.style.background='rgba(0,255,136,0.1)';this.style.color='#00ffcc'" onmouseout="this.style.background='transparent';this.style.color='#d9eef5'">⭐ Make Manager</button>
                          <button v-if="isAdmin" @click="setStaffRole(usr.id, null); closeUserMenu()" style="display:block;width:100%;text-align:left;padding:10px 16px;background:transparent;border:none;color:#d9eef5;cursor:pointer;transition:all 0.2s;font-size:13px;border-bottom:1px solid rgba(0,255,136,0.1)" onmouseover="this.style.background='rgba(0,255,136,0.1)';this.style.color='#9bb0bd'" onmouseout="this.style.background='transparent';this.style.color='#d9eef5'">❌ Remove Staff</button>
                          
                          <!-- Section: User Management -->
                          <div style="padding:8px 12px;color:#00ff88;font-size:11px;font-weight:700;text-transform:uppercase;letter-spacing:1px;border-bottom:1px solid rgba(0,255,136,0.1);margin-top:4px">User Management</div>
                          <button v-if="isAdmin" @click="openEmailModal(usr); closeUserMenu()" style="display:block;width:100%;text-align:left;padding:10px 16px;background:transparent;border:none;color:#d9eef5;cursor:pointer;transition:all 0.2s;font-size:13px" onmouseover="this.style.background='rgba(0,255,204,0.1)';this.style.color='#00ffcc'" onmouseout="this.style.background='transparent';this.style.color='#d9eef5'">✉️ Change Email</button>
                          <button v-if="isAdmin" @click="openUidModal(usr); closeUserMenu()" style="display:block;width:100%;text-align:left;padding:10px 16px;background:transparent;border:none;color:#d9eef5;cursor:pointer;transition:all 0.2s;font-size:13px;border-bottom:1px solid rgba(0,255,136,0.1)" onmouseover="this.style.background='rgba(0,255,204,0.1)';this.style.color='#00ffcc'" onmouseout="this.style.background='transparent';this.style.color='#d9eef5'">🔢 Change UID</button>
                          
                          <!-- Section: Access Control -->
                          <div style="padding:8px 12px;color:#ffa500;font-size:11px;font-weight:700;text-transform:uppercase;letter-spacing:1px;border-bottom:1px solid rgba(0,255,136,0.1);margin-top:4px">Access Control</div>
                          <button v-if="isAdmin" @click="revokeUserAccess(usr.id); closeUserMenu()" style="display:block;width:100%;text-align:left;padding:10px 16px;background:transparent;border:none;color:#d9eef5;cursor:pointer;transition:all 0.2s;font-size:13px;border-bottom:1px solid rgba(0,255,136,0.1)" onmouseover="this.style.background='rgba(255,165,0,0.1)';this.style.color='#ffa500'" onmouseout="this.style.background='transparent';this.style.color='#d9eef5'">🚫 Revoke Key Access</button>
                          
                          <!-- Section: Invites -->
                          <div style="padding:8px 12px;color:#51cf66;font-size:11px;font-weight:700;text-transform:uppercase;letter-spacing:1px;border-bottom:1px solid rgba(0,255,136,0.1);margin-top:4px">Invites</div>
                          <button v-if="isAdmin" @click="openInviteModal(usr); closeUserMenu()" style="display:block;width:100%;text-align:left;padding:10px 16px;background:transparent;border:none;color:#d9eef5;cursor:pointer;transition:all 0.2s;font-size:13px" onmouseover="this.style.background='rgba(0,255,136,0.1)';this.style.color='#00ff88'" onmouseout="this.style.background='transparent';this.style.color='#d9eef5'">📨 Send Invite Key</button>
                          <button v-if="isAdmin" @click="generateInviteKey(); closeUserMenu()" style="display:block;width:100%;text-align:left;padding:10px 16px;background:transparent;border:none;color:#d9eef5;cursor:pointer;transition:all 0.2s;font-size:13px;border-bottom:1px solid rgba(0,255,136,0.1)" onmouseover="this.style.background='rgba(81,207,102,0.1)';this.style.color='#51cf66'" onmouseout="this.style.background='transparent';this.style.color='#d9eef5'">📋 Generate Key (Clipboard)</button>
                          
                          <!-- Section: Moderation -->
                          <div style="padding:8px 12px;color:#ff6b6b;font-size:11px;font-weight:700;text-transform:uppercase;letter-spacing:1px;border-bottom:1px solid rgba(0,255,136,0.1);margin-top:4px">Moderation</div>
                          <button v-if="isAdmin" @click="openBanModal(usr); closeUserMenu()" style="display:block;width:100%;text-align:left;padding:10px 16px;background:transparent;border:none;color:#d9eef5;cursor:pointer;transition:all 0.2s;font-size:13px" onmouseover="this.style.background='rgba(255,107,107,0.1)';this.style.color='#ff6b6b'" onmouseout="this.style.background='transparent';this.style.color='#d9eef5'">
                            {{ usr.banned ? '✅ Unban User' : '🔨 Ban User' }}
                          </button>
                        </div>
                      </div>
                    </td>
